# ⚙️ Atividade 3 – Parte 1
**Engenharia de Software II**

Este repositório contém todos os **artefatos, evidências, scripts, prompts, análises manuais e análises via Inteligência Artificial** utilizados na **Atividade 03** da disciplina de **Engenharia de Software II**.
